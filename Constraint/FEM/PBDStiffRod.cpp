...
//    while(    (std::abs(rhs.maxCoeff()) < m_maxError.getValue()
//               || std::abs(rhs.minCoeff()) < m_maxError.getValue())
//              && iter < m_nbIter.getValue ()
//              )
//    {
//        std::cout<<std::endl;
...
//                u[begin].coeffs () += G * (-1.0*dx.block<3,1>(0,0));//q.coeffs ();
//                u[begin].normalize ();
...
//                //Quaternionr q(0.0,dx(3),dx(4),dx(5));
//                u[end].coeffs () +=  G * (-1.0 * dx.block<3,1>(0,0));//q.coeffs ();
//                u[end].normalize ();
...
//        SReal LI = l[i]*I;
//        invMass[i] << object.mass (i), object.mass (i), object.mass (i),LI,LI,2.0*LI;
//    }
